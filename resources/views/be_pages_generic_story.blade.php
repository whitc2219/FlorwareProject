                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_pages_generic_story">Story</a>
                                    </li>
                                    <li>
                        ...
                        <div class="content content-top text-center">
                            <div class="py-100">
                                ...
                                <div class="font-size-md text-muted">
                                    <a class="text-body-bg-dark" href="be_pages_generic_profile">John Smith</a> &bull; June 5, 2017
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row no-gutters push js-gallery img-fluid-100">
                                <div class="col-6 animated fadeIn">
                                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="assets/media/photos/photo32@2x.jpg">
                                        <img class="img-fluid" src="assets/media/photos/photo32.jpg" alt="">
                                    </a>
                                </div>
                                <div class="col-6 animated fadeIn">
                                    <a class="img-link img-link-simple img-link-zoom-in img-lightbox" href="assets/media/photos/photo31@2x.jpg">
                                        <img class="img-fluid" src="assets/media/photos/photo31.jpg" alt="">
                                    </a>
                                </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="media mb-30">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-5"><a class="font-w600" href="javascript:void(0)">Marie Duncan</a> Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                        ...
                                        <div class="media my-20">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-5"><a class="font-w600" href="javascript:void(0)">Judy Ford</a> Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                                <div class="font-size-sm">
                                        ...
                                        <div class="media my-20">
                                            ...
                                            <div class="media-body">
                                                <p class="mb-5"><a class="font-w600" href="javascript:void(0)">Ralph Murray</a> Purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                                <div class="font-size-sm">
                                ...
                                <div class="media mb-30">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-5"><a class="font-w600" href="javascript:void(0)">Ralph Murray</a> In gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                        <div class="font-size-sm">
                                ...
                                <div class="media mb-30">
                                    <img class="img-avatar img-avatar48 d-flex mr-20" src="assets/media/avatars/avatar5.jpg" alt="">
                                    <div class="media-body">
                                        <p class="mb-5"><a class="font-w600" href="javascript:void(0)">Laura Carr</a> Vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                                        <div class="font-size-sm">
                                            <a class="link-effect" href="javascript:void(0)">Like</a>
                                            <span role="presentation" aria-hidden="true"> · </span>
                                            <a class="link-effect" href="javascript:void(0)">Reply</a>
                                ...
                                <div class="media mb-30">
                                    ...
                                    <div class="media-body">
                                        <form action="be_pages_generic_story" method="post" onsubmit="return false;">
