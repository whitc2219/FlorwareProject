                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_blocks_widgets_stats">Statistics</a>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="row gutters-tiny">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <a class="block block-transparent" href="javascript:void(0)">
                                <div class="block-content block-content-full text-right bg-image" style="background-image: url('assets/media/photos/photo26.jpg');">
                        ...
                        <div class="col-md-6 col-xl-3">
                            <a class="block block-transparent" href="javascript:void(0)">
                                <div class="block-content block-content-full text-right bg-image" style="background-image: url('assets/media/photos/photo28.jpg');">
                                    <div class="py-50 text-center bg-black-op-25">
                    ...
                    <div class="row gutters-tiny">
                        <!-- Row #3 -->
                        <div class="col-md-6">
                            <div class="block block-transparent bg-image" style="background-image: url('assets/media/photos/photo13.jpg');">
                        ...
                        <div class="col-md-6">
                            <div class="block block-transparent bg-image" style="background-image: url('assets/media/photos/photo22.jpg');">
                    ...
                    <div class="row gutters-tiny">
                        <!-- Row #2 -->
                        <div class="col-md-6">
                            <div class="block block-transparent bg-image" style="background-image: url('assets/media/photos/photo23@2x.jpg');">
                        ...
                        <div class="col-md-6">
                            <div class="block block-transparent bg-image" style="background-image: url('assets/media/photos/photo27@2x.jpg');">
