            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        ...
                        <ul class="nav-main">
                            <li>
                                <a class="active" href="db_classic"><i class="si si-cup"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                            </li>
                            <li class="nav-main-heading"><span class="sidebar-mini-visible">HQ</span><span class="sidebar-mini-hidden">Headquarters</span></li>
                            <li>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-briefcase"></i><span class="sidebar-mini-hide">Projects</span></a>
                                <ul>
                                    <li>
                                        <a href="">New</a>
                                    </li>
                            ...
                            <li>
                                <a href=""><i class="si si-layers"></i><span class="sidebar-mini-hide">Requests</span></a>
                            </li>
                            <li class="nav-main-heading"><span class="sidebar-mini-visible">ST</span><span class="sidebar-mini-hidden">Settings</span></li>
                            <li>
                                <a href=""><i class="si si-notebook"></i><span class="sidebar-mini-hide">Profile</span></a>
                            </li>
                            <li>
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section">
                        ...
                        <div class="content-header-item d-none d-sm-inline-block ml-5">
                            <form action="db_classic" method="post" onsubmit="return false;">
                                <div class="input-group">
