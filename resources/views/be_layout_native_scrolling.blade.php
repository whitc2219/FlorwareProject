...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o enable-page-overlay page-header-modern main-content-boxed">
            <!-- Side Overlay-->
                                ...
                                <ul>
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_layout_native_scrolling">Native Scrolling</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
