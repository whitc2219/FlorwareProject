...
<html lang="en" class="no-focus">
    ...
    <body>
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_comp_image_cropper">Image Cropper</a>
                                    </li>
                                    <li>
                    ...
                    <div class="block">
                        <div class="block-content">
                            <div class="row items-push">
                                <div class="col-xl-8">
                                    <div>
                                        <img id="js-img-cropper" class="img-fluid" src="assets/media/photos/photo22@2x.jpg" alt="photo">
                                    </div>
                                </div>
                                <div class="col-xl-4">
        ...
        <!-- Page JS Code -->
        <script src="assets/js/pages/be_comp_image_cropper.min.js"></script>
    </body>
</html>