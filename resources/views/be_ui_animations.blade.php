                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_ui_animations">Animations</a>
                                    </li>
                                    <li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-center">
                                    <div class="js-animation-object">
                                        <img class="img-fluid" src="assets/media/various/little-face.png" alt="" width="150">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="block js-animation-section">
                        ...
                        <div class="block-content block-content-full">
                            <div class="row">
                                ...
                                <div class="col-lg-6 text-center">
                                    <div class="js-animation-object">
                                        <img class="img-fluid" src="assets/media/various/little-face.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
