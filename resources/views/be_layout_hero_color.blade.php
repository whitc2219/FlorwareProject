                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            <li>
                                                <a class="active" href="be_layout_hero_color">Color</a>
                                            </li>
                                            <li>
                    ...
                    <div class="hero bg-black-op-5">
                        <div class="hero-inner">
                            <div class="content content-full text-center">
                                ...
                                <a class="btn btn-hero btn-noborder btn-rounded btn-alt-primary invisible" data-toggle="appear" data-class="animated fadeInUp" data-timeout="300" href="be_layout_hero_color">
