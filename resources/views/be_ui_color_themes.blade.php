                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_ui_color_themes">Color Themes</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="block">
                        <div class="block-content">
                            <div class="row items-push text-center">
                                ...
                                <div class="col-6 col-md-6 col-xl-2">
                                    <a class="item item-circle bg-elegance text-white-op mx-auto mb-15" data-toggle="theme" data-theme="assets/css/themes/elegance.min.css" href="javascript:void(0)">
                                        <i class="fa fa-paint-brush"></i>
                                    </a>
                                    <div class="font-w600">Elegance</div>
                                </div>
                                <div class="col-6 col-md-6 col-xl-2">
                                    <a class="item item-circle bg-pulse text-white-op mx-auto mb-15" data-toggle="theme" data-theme="assets/css/themes/pulse.min.css" href="javascript:void(0)">
                                        <i class="fa fa-paint-brush"></i>
                                    </a>
                                    <div class="font-w600">Pulse</div>
                                </div>
                                <div class="col-6 col-md-6 col-xl-2">
                                    <a class="item item-circle bg-flat text-white-op mx-auto mb-15" data-toggle="theme" data-theme="assets/css/themes/flat.min.css" href="javascript:void(0)">
                                        <i class="fa fa-paint-brush"></i>
                                    </a>
                                    <div class="font-w600">Flat</div>
                                </div>
                                <div class="col-6 col-md-6 col-xl-2">
                                    <a class="item item-circle bg-corporate text-white-op mx-auto mb-15" data-toggle="theme" data-theme="assets/css/themes/corporate.min.css" href="javascript:void(0)">
                                        <i class="fa fa-paint-brush"></i>
                                    </a>
                                    <div class="font-w600">Corporate</div>
                                </div>
                                <div class="col-6 col-md-6 col-xl-2">
                                    <a class="item item-circle bg-earth text-white-op mx-auto mb-15" data-toggle="theme" data-theme="assets/css/themes/earth.min.css" href="javascript:void(0)">
                                        <i class="fa fa-paint-brush"></i>
                                    </a>
