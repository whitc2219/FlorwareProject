        ...
        <div id="page-container" class="sidebar-inverse side-scroll page-header-fixed page-header-inverse main-content-boxed">
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="bd_variations_hero_video_1">Hero Video 1</a>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <div class="content content-full">
                    ...
                    <div class="block block-transparent bg-video" data-vide-bg="assets/media/videos/city_night" data-vide-options="posterType: jpg">
