                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            <li>
                                                <a class="active" href="be_pages_elearning_courses">Courses</a>
                                            </li>
                                            <li>
                ...
                <div class="content">
                    ...
                    <div class="row row-deck items-push">
                        <div class="col-md-6 col-xl-3">
                            <a class="block block-link-shadow block-rounded ribbon ribbon-bookmark ribbon-left ribbon-success text-center" href="be_pages_elearning_course">
                    ...
                    <div class="row items-push">
                        <div class="col-md-6 col-xl-4">
                            <div class="block block-rounded text-center">
                                ...
                                <div class="block-content block-content-full">
                                    <div class="font-size-h5 font-w600 mb-0">Marie Duncan</div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="block block-rounded text-center">
                                ...
                                <div class="block-content block-content-full">
                                    <div class="font-size-h5 font-w600 mb-0">Susan Day</div>
                        ...
                        <div class="col-xl-4">
                            <div class="block block-rounded text-center">
                                ...
                                <div class="block-content block-content-full">
                                    <div class="font-size-h5 font-w600 mb-0">Justin Hunt</div>
