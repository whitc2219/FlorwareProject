                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    <li>
                                        <a class="active" href="be_pages_error_all">All</a>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <!-- 400 -->
                            <a class="block block-link-shadow" href="op_error_400">
                        ...
                        <div class="col-md-4">
                            <!-- 401 -->
                            <a class="block block-link-shadow" href="op_error_401">
                                <div class="block-content text-center">
                                    <div class="py-20">
                        ...
                        <div class="col-md-4">
                            <!-- 403 -->
                            <a class="block block-link-shadow" href="op_error_403">
                                <div class="block-content text-center">
                                    <div class="py-20">
                        ...
                        <div class="col-md-4">
                            <!-- 404 -->
                            <a class="block block-link-shadow" href="op_error_404">
                                <div class="block-content text-center">
                                    <div class="py-20">
                        ...
                        <div class="col-md-4">
                            <!-- 500 -->
                            <a class="block block-link-shadow" href="op_error_500">
                                <div class="block-content text-center">
                                    <div class="py-20">
                        ...
                        <div class="col-md-4">
                            <!-- 503 -->
                            <a class="block block-link-shadow" href="op_error_503">
                                <div class="block-content text-center">
                                    <div class="py-20">
