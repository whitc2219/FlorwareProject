                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_comp_chat_single">Single</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                ...
                <div class="js-chat-container content content-full invisible" data-toggle="appear" data-chat-height="350">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="block block-rounded block-themed">
                                ...
                                <div class="js-chat-form block-content block-content-full block-content-sm bg-body-light">
                                    <form action="be_comp_chat_single" method="post">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="block block-rounded block-themed">
                                <!-- Chat Header -->
                                <div class="js-chat-head block-content block-content-full block-sticky-options text-center bg-image" style="background-image: url('assets/media/photos/photo26.jpg');">
                                    <div class="block-options">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="block block-rounded block-themed">
                                <!-- Chat Header -->
                                <div class="js-chat-head block-content block-content-full block-sticky-options text-center bg-image" style="background-image: url('assets/media/photos/photo23.jpg');">
                                    <div class="block-options">
                                        <button type="button" class="btn-block-option" data-toggle="block-option" data-action="state_toggle" data-action-mode="demo">
                                            <i class="si si-refresh"></i>
                                        </button>
