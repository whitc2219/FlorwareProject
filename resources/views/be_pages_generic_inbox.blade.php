                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_pages_generic_inbox">Inbox</a>
                                    </li>
                                    <li>
                                    ...
                                    <table class="js-table-checkable table table-hover table-vcenter">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-none d-sm-table-cell font-w600">Justin Hunt</td>
                                                <td>
            ...
            <div class="modal-dialog modal-dialog-top" role="document">
                <div class="modal-content">
                    <div class="block block-themed block-transparent mb-0">
                        ...
                        <div class="block-content">
                            <form class="my-10" action="be_pages_generic_inbox" method="post" onsubmit="return false;">
                                <div class="form-group row">
                                    <div class="col-12">
