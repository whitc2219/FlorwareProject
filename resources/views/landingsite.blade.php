            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li style="margin-top: 9px" class="nav-item nl-simple"><a href="#" style="padding-left: 20px; padding-right: 15px; border-top: 30px;" class="ico-facebook"><i class="fab fa-facebook-f fa-lg" ></i></a></li>
                        <li style="color: grey; margin-top: 9px" class="nav-item nl-simple"><a href="#" style="alignment: bottom; padding-left: 1px; padding-right: 15px; margin-top: 30px;" class="ico-twitter"><i class="fab fa-instagram fa-lg"></i></a></li>
