    ...
    <header id="header" class="header">
        <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-tra hover-menu">
            <div class="container">
                ...
                <a href="#hero-15" class="navbar-brand logo-black"><img src="images/OrrLogo2.png" width="70" height="70" alt="header-logo"></a>
                <a href="#hero-15" class="navbar-brand logo-white"><img src="images/OrrLogo2.png" width="70" height="70" alt="header-logo"></a>
