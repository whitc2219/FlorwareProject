            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li style="margin-top: 9px" class="nav-item nl-simple"><a href="#" style="color: grey; padding-left: 20px; padding-right: 15px;" class="ico-facebook"><i class="fab fa-facebook-f fa-lg" ></i></a></li>
                        <li style="margin-top: 9px" class="nav-item nl-simple"><a href="#" style="color: grey; padding-left: 1px; padding-right: 15px;" class="ico-twitter"><i class="fab fa-instagram fa-lg"></i></a></li>
