            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item nl-simple"><a href="#" style="padding-left: 20px; padding-right: 15px; border-top: 30px;" class="ico-facebook"><i class="fab fa-facebook-f fa-1x" ></i></a></li>
                        <li class="nav-item nl-simple"><a href="#" style="alignment: center; padding-left: 1px; padding-right: 15px; margin-top: 30px;" class="ico-twitter"><i class="fab fa-instagram fa-1x"></i></a></li>
