            ...
            <div class="container">
                ...
                <div id="navbarSupportedContent" class="collapse navbar-collapse">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li style="margin-top: 10px; padding-top: 10px; border-top: 10px; alignment: bottom" class="nav-item nl-simple"><a href="#" style="alignment: bottom; padding-left: 1px; padding-right: 15px; margin-top: 30px;" class="ico-twitter"><i class="fab fa-instagram fa-lg"></i></a></li>
