                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_pages_real_estate_listing_new">Add New Listing</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded block-fx-shadow">
                        <div class="block-content">
                            <form action="be_pages_real_estate_listing_new" method="POST" enctype="multipart/form-data" onsubmit="return false;">
                                <!-- Photos -->
