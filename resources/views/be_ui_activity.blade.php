                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_ui_activity">Activity</a>
                                    </li>
                                    <li>
                        ...
                        <div class="block-content">
                            ...
                            <div class="row items-push-3x">
                                <div class="col-6 col-md-3">
                                    <a class="item item-circle bg-gd-dusk mx-auto" href="javascript:void(0)" onclick="Codebase.loader('show', 'bg-gd-dusk');setTimeout(function () {
                                                Codebase.loader('hide');
                                            }, 3000);"></a>
                                </div>
                                <div class="col-6 col-md-3">
                                ...
                                <div class="col-6 col-md-3">
                                    <a class="item item-circle bg-gd-sun mx-auto" href="javascript:void(0)" onclick="Codebase.loader('show', 'bg-gd-sun');
                                            setTimeout(function () {
                                                Codebase.loader('hide');
                                            }, 3000);"></a>
                                </div>
