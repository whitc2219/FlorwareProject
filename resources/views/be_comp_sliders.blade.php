                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_comp_sliders">Sliders</a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="block">
                                ...
                                <div class="js-slider slick-nav-white slick-nav-hover" data-dots="true" data-arrows="true">
                                    <div>
                                        <img class="img-fluid" src="assets/media/photos/photo7.jpg" alt="">
                                    </div>
                                    <div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="block">
                                ...
                                <div class="js-slider slick-nav-black slick-nav-hover" data-dots="true" data-arrows="true" data-slides-to-show="3" data-center-mode="true" data-autoplay="true" data-autoplay-speed="3000">
                                    ...
                                    <div>
                                        <img class="img-fluid" src="assets/media/photos/photo29.jpg" alt="">
                                    </div>
                                    <div>
                                ...
                                <div class="block-content">
                                    <div class="js-slider text-center" data-autoplay="true" data-dots="true" data-arrows="true" data-slides-to-show="3">
                                        <div class="py-20">
                                            ...
                                            <div class="mt-10 font-w600">Carol White</div>
                                            <div class="font-size-sm text-muted">Graphic Designer</div>
                                        </div>
                                        <div class="py-20">
                                            <img class="img-avatar" src="assets/media/avatars/avatar5.jpg" alt="">
                                            <div class="mt-10 font-w600">Judy Ford</div>
                                            <div class="font-size-sm text-muted">Photographer</div>
                                        </div>
                                        <div class="py-20">
                                            <img class="img-avatar" src="assets/media/avatars/avatar6.jpg" alt="">
                                            <div class="mt-10 font-w600">Carol Ray</div>
                                            <div class="font-size-sm text-muted">Web Developer</div>
                                        </div>
                                        <div class="py-20">
                                            <img class="img-avatar" src="assets/media/avatars/avatar1.jpg" alt="">
                                            <div class="mt-10 font-w600">Amber Harvey</div>
                                            <div class="font-size-sm text-muted">Web Designer</div>
                                        </div>
                                        <div class="py-20">
                                            <img class="img-avatar" src="assets/media/avatars/avatar2.jpg" alt="">
                                            <div class="mt-10 font-w600">Andrea Gardner</div>
                                            <div class="font-size-sm text-muted">Font Designer</div>
                                        </div>
                                        <div class="py-20">
                                            <img class="img-avatar" src="assets/media/avatars/avatar3.jpg" alt="">
                                            <div class="mt-10 font-w600">Megan Fuller</div>
                                            <div class="font-size-sm text-muted">Artist</div>
                                        </div>
                                    </div>
                                </div>
