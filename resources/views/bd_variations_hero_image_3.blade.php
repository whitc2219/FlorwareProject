        ...
        <div id="page-container" class="sidebar-inverse side-scroll page-header-fixed page-header-inverse main-content-boxed">
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="bd_variations_hero_image_3">Hero Image 3</a>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <div class="content content-full">
                    <!-- Hero -->
                    <div class="block block-rounded block-transparent bg-image bg-image-bottom" style="background-image: url('assets/media/photos/photo13@2x.jpg');">
