                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    <li>
                                        <a class="active" href="be_pages_auth_all">All</a>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Sign In -->
                            <a class="block block-link-shadow" href="op_auth_signin">
                        ...
                        <div class="col-md-6">
                            <!-- Register -->
                            <a class="block block-link-shadow" href="op_auth_signup">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                        ...
                        <div class="col-md-6">
                            <!-- Password Reminder -->
                            <a class="block block-link-shadow" href="op_auth_reminder">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                        ...
                        <div class="col-md-6">
                            <!-- Lock -->
                            <a class="block block-link-shadow" href="op_auth_lock">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Sign In -->
                            <a class="block block-link-shadow" href="op_auth_signin2">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-login font-size-h1 text-info"></i>
                        ...
                        <div class="col-md-6">
                            <!-- Register -->
                            <a class="block block-link-shadow" href="op_auth_signup2">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-user-follow font-size-h1 text-success"></i>
                        ...
                        <div class="col-md-6">
                            <!-- Password Reminder -->
                            <a class="block block-link-shadow" href="op_auth_reminder2">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-bulb font-size-h1 text-warning"></i>
                        ...
                        <div class="col-md-6">
                            <!-- Lock -->
                            <a class="block block-link-shadow" href="op_auth_lock2">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-lock font-size-h1 text-danger"></i>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Sign In -->
                            <a class="block block-link-shadow" href="op_auth_signin3">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-login font-size-h1 text-info"></i>
                        ...
                        <div class="col-md-6">
                            <!-- Register -->
                            <a class="block block-link-shadow" href="op_auth_signup3">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-user-follow font-size-h1 text-success"></i>
                        ...
                        <div class="col-md-6">
                            <!-- Password Reminder -->
                            <a class="block block-link-shadow" href="op_auth_reminder3">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-bulb font-size-h1 text-warning"></i>
                        ...
                        <div class="col-md-6">
                            <!-- Lock -->
                            <a class="block block-link-shadow" href="op_auth_lock3">
                                <div class="block-content text-center">
                                    <div class="py-20">
                                        <p class="mb-10">
                                            <i class="si si-lock font-size-h1 text-danger"></i>
