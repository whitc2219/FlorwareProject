                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_pages_ecom_product_edit">Product Edit</a>
                                            </li>
                                            <li>
            ...
            <main id="main-container">
                    ...
                    <div class="bg-black-op-75">
                        <div class="content content-top content-full text-center">
                            <div class="py-20">
                                ...
                                <h2 class="h4 font-w400 text-white-op mb-0">In <a class="text-primary-light link-effect" href="be_pages_ecom_products">video game</a> category.</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-body-light border-b">
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            ...
                            <a class="breadcrumb-item" href="be_pages_ecom_products">Products</a>
                ...
                <div class="content">
                    ...
                    <div class="row gutters-tiny">
                        <!-- Basic Info -->
                        <div class="col-md-7">
                            <form action="be_pages_ecom_product_edit" method="post" onsubmit="return false;">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="block block-rounded block-themed">
                                ...
                                <div class="block-content block-content-full">
                                    ...
                                    <form class="dropzone" action="be_pages_ecom_product_edit"></form>
                                </div>
                            </div>
                            <!-- END Images -->
                        </div>
