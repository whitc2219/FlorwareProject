                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_tables_helpers">Helpers</a>
                                    </li>
                                    <li>
                        ...
                        <div class="block-content">
                            ...
                            <table class="js-table-sections table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $150,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="font-size-sm text-muted">October 22, 2017 12:16</span>
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $251,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $163,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $274,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="font-size-sm text-muted">October 15, 2017 12:16</span>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody class="js-table-sections-header">
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                            <em class="text-muted">October 8, 2017 12:16</em>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody>
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $184,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $226,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $109,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="font-size-sm text-muted">October 21, 2017 12:16</span>
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $276,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="font-size-sm text-muted">October 19, 2017 12:16</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $186,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="font-size-sm text-muted">October 6, 2017 12:16</span>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $98,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="font-size-sm text-muted">October 23, 2017 12:16</span>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody class="js-table-sections-header">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $213,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                                    ...
                                    <tr>
                                        <td class="text-center"></td>
                                        <td class="font-w600 text-success">+ $253,00</td>
                                        <td class="font-size-sm">Stripe</td>
                                        <td class="d-none d-sm-table-cell">
                            ...
                            <table class="js-table-checkable table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                            <em class="text-muted">November 19, 2017 13:17</em>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">
                                        ...
                                        <td>
                                            <p class="font-w600 mb-10">Megan Fuller</p>
                                            <p class="text-muted mb-0">Customer details and further information</p>
                                        </td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="badge badge-primary">Personal</span>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                            <em class="text-muted">November 18, 2017 13:17</em>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">
                                        ...
                                        <td>
                                            <p class="font-w600 mb-10">Susan Day</p>
                                            <p class="text-muted mb-0">Customer details and further information</p>
                                        </td>
                                        <td class="d-none d-sm-table-cell">
                                            <span class="badge badge-primary">Personal</span>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none d-sm-table-cell">
                                            <em class="text-muted">November 25, 2017 13:17</em>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">
