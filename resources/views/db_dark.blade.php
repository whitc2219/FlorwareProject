...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed page-header-glass page-header-inverse main-content-boxed">
            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            <li>
                                <a class="active" href="db_dark"><i class="si si-home"></i><span class="sidebar-mini-hide">Home <span class="badge badge-pill badge-primary ml-5">3</span></span></a>
                            </li>
                    ...
                    <div class="content content-top">
                        ...
                        <div class="row invisible" data-toggle="appear">
                            ...
                            <div class="col-6 col-md-4 col-xl-2">
                                <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_pages_generic_inbox">
                            ...
                            <div class="col-6 col-md-4 col-xl-2">
                                <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_pages_generic_profile">
                                    <div class="block-content">
                                        <p class="mt-5">
                            ...
                            <div class="col-6 col-md-4 col-xl-2">
                                <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_pages_forum_categories">
                            ...
                            <div class="col-6 col-md-4 col-xl-2">
                                <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_pages_generic_search">
                                    <div class="block-content">
                                        <p class="mt-5">
                            ...
                            <div class="col-6 col-md-4 col-xl-2">
                                <a class="block block-rounded block-transparent bg-black-op text-body-color-light text-center" href="be_comp_charts">
                                    <div class="block-content">
                                        <p class="mt-5">
