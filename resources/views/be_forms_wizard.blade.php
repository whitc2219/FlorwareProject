                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_forms_wizard">Wizard</a>
                                    </li>
                                    <li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="js-wizard-simple block">
                                ...
                                <!-- Form -->
                                <form action="be_forms_wizard" method="post">
                                    <!-- Steps Content -->
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="js-wizard-validation-classic block">
                                ...
                                <!-- Form -->
                                <form class="js-wizard-validation-classic-form" action="be_forms_wizard" method="post">
                                    <!-- Steps Content -->
                                    <div class="block-content block-content-full tab-content" style="min-height: 265px;">
                                        <!-- Step 1 -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="js-wizard-validation-material block">
                                ...
                                <!-- Form -->
                                <form class="js-wizard-validation-material-form" action="be_forms_wizard" method="post">
                                    <!-- Steps Content -->
                                    <div class="block-content block-content-full tab-content" style="min-height: 267px;">
                                        <!-- Step 1 -->
