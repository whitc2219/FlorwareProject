...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-glass main-content-boxed">
            <!-- Side Overlay-->
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_layout_hero_bubbles">Bubbles</a>
                                            </li>
                                            <li>
                    ...
                    <div class="hero bg-white">
                        <div class="hero-inner">
                            <div class="content content-full text-center">
                                ...
                                <a class="btn btn-hero btn-noborder btn-rounded btn-alt-primary invisible" data-toggle="appear" data-class="animated fadeInUp" data-timeout="300" href="be_layout_hero_bubbles">
