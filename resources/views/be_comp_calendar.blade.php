...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll">
            <!-- Side Overlay-->
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_comp_calendar">Calendar</a>
                                    </li>
                                    <li>
                        ...
                        <div class="block-content">
                            <div class="row items-push">
                                ...
                                <div class="col-xl-3 d-none d-xl-block">
                                    <!-- Add Event Form -->
                                    <form class="js-form-add-event mb-30" action="be_comp_calendar" method="post">
                                        <div class="input-group">
