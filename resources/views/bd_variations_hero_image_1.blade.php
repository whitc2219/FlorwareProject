        ...
        <div id="page-container" class="sidebar-inverse side-scroll page-header-fixed page-header-inverse main-content-boxed">
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="bd_variations_hero_image_1">Hero Image 1</a>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <div class="content content-full">
                    <!-- Hero -->
                    <div class="block block-rounded bg-image" style="background-image: url('assets/media/photos/photo32@2x.jpg');">
