...
<html lang="en" class="no-focus">
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="assets/js/plugins/highlightjs/styles/github-gist.css">
    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-glass page-header-inverse main-content-boxed">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_pages_elearning_lesson">Lesson</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
            ...
            <main id="main-container">
                ...
                <!-- Hero -->
                <div class="bg-image" style="background-image: url('assets/media/various/landing-promo-developer-minded-html@2x.png');">
                ...
                <div class="content">
                    <nav class="breadcrumb bg-white push">
                        <a class="breadcrumb-item" href="be_pages_elearning_courses">Courses</a>
                        <a class="breadcrumb-item" href="be_pages_elearning_course">Learn HTML</a>
