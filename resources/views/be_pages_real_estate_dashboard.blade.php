                            ...
                            <ul class="nav-users push">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile">
                                        ...
                                        <i class="fa fa-circle text-danger"></i> Jose Wagner
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            <li>
                                                <a class="active" href="be_pages_real_estate_dashboard">Dashboard</a>
                                            </li>
                                            <li>
                ...
                <div class="content">
                    <div class="my-50 text-center">
                        ...
                        <h3 class="h5 text-muted mb-0">
                            You currently have 6 properties! <a href="be_pages_real_estate_listing_new">Add a new one</a>.
                        </h3>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing">
                                ...
                                <div class="block-content block-content-full">
                                    <div class="row">
                                        <div class="col-6">
                                            <a class="btn btn-sm btn-hero btn-noborder btn-secondary btn-block" href="be_pages_real_estate_listing">
                                                Details
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <a class="btn btn-sm btn-hero btn-noborder btn-primary btn-block" href="be_pages_real_estate_listing_new">
                                                Edit
                                            </a>
                                        </div>
                                    </div>
