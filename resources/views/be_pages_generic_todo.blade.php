...
<html lang="en" class="no-focus">
    ...
    <body>
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_pages_generic_todo">Todo</a>
                                    </li>
                                    <li>
                ...
                <div class="content">
                    ...
                    <div class="row">
                            ...
                            <div class="js-tasks-nav d-none d-md-block">
                                ...
                                <div class="block block-rounded">
                                    ...
                                    <div class="block-content">
                                        ...
                                        <form class="push" action="be_pages_generic_todo" method="post" onsubmit="return false;">
                                            <div class="input-group">
                        ...
                        <div class="col-md-7 col-xl-9">
                            ...
                            <div class="js-tasks">
                                <!-- Add task -->
                                <form id="js-task-form" action="be_pages_generic_todo" method="post">
        ...
        <!-- Page JS Code -->
        <script src="assets/js/pages/be_pages_generic_todo.min.js"></script>
    </body>
</html>