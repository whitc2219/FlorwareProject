...
<html lang="en" class="no-focus">
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="assets/js/plugins/jquery-jvectormap/dist/jquery-jvectormap.css">
    ...
    <body>
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_comp_maps_vector">Vector Maps</a>
                                    </li>
                                    <li>
        ...
        <!-- Page JS Plugins -->
        <script src="assets/js/plugins/jquery-jvectormap/dist/jquery-jvectormap.min.js"></script>
        ...
        <!-- Page JS Code -->
        <script src="assets/js/pages/be_comp_maps_vector.min.js"></script>
    </body>
</html>