                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_pages_generic_project">Project</a>
                                    </li>
                                    <li>
                ...
                <div class="content">
                    ...
                    <div class="block">
                        ...
                        <div class="block-content block-content-full border-b clearfix">
                            ...
                            <a class="btn btn-secondary" href="be_pages_generic_project_list">
                            ...
                            <div class="row py-20">
                                <div class="col-sm-6 invisible" data-toggle="appear">
                                    ...
                                    <div class="js-slider slick-nav-black slick-dotted-inner slick-dotted-white" data-dots="true" data-arrows="true">
                                        <div>
                                            <img class="img-fluid" src="assets/media/various/cb-project-promo1.png" alt="Project Promo 1">
                                        </div>
                                        <div>
                                            <img class="img-fluid" src="assets/media/various/cb-project-promo2.png" alt="Project Promo 2">
                                        </div>
                                        <div>
                                            <img class="img-fluid" src="assets/media/various/cb-project-promo3.png" alt="Project Promo 3">
                                        </div>
                                    </div>
                                    <!-- END Image Slider -->
