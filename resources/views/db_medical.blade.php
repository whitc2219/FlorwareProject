                        ...
                        <div class="block-content">
                            <ul class="list list-activity">
                                ...
                                <li>
                                    ...
                                    <div>
                                        <a class="font-w600 text-success" href="javascript:void(0)">Ryan Flores</a>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div>
                                        From <a class="font-w600" href="javascript:void(0)">Amanda Powell</a>
                                    </div>
                                    <div class="font-size-xs text-muted">1 day ago</div>
                                </li>
                                <li>
                                    ...
                                    <div>
                                        Tomorrow with <a class="font-w600 text-success" href="javascript:void(0)">Amber Harvey</a>
                                    </div>
            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            <li>
                                <a class="active" href="db_medical"><i class="fa fa-hospital-o"></i><span class="sidebar-mini-hide">Overview</span></a>
                            </li>
                ...
                <div class="content-header">
                    ...
                    <div class="content-header-section">
                        ...
                        <div class="content-header-item d-none d-sm-inline-block">
                            <form action="db_medical" method="post" onsubmit="return false;">
