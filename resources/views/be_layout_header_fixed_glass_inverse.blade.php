...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-glass page-header-inverse main-content-boxed">
            <!-- Side Overlay-->
                                        ...
                                        <ul>
                                            ...
                                            <li class="open">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a class="active" href="be_layout_header_fixed_glass_inverse">Glass Inverse</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
