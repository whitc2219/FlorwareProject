                        ...
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a class="active" href="be_comp_filtering">Filtering</a>
                                    </li>
                                    <li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3" data-category="family">
                                <a class="block block-link-pop" href="javascript:void(0)">
                                    ...
                                    <div class="block-content block-content-full bg-body-light text-center">
                                        <div class="font-w600 mb-5">Scott Young</div>
                                        <div class="font-size-sm text-muted">Web Designer</div>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6 col-xl-3" data-category="family">
                                <a class="block block-link-pop" href="javascript:void(0)">
                                    ...
                                    <div class="block-content block-content-full bg-body-light text-center">
                                        <div class="font-w600 mb-5">Laura Carr</div>
                            ...
                            <div class="col-md-6 col-xl-3" data-category="work">
                                <a class="block block-link-pop" href="javascript:void(0)">
                                    ...
                                    <div class="block-content block-content-full bg-body-light text-center">
                                        <div class="font-w600 mb-5">Thomas Riley</div>
