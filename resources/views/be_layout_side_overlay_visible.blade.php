...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o side-overlay-o enable-page-overlay side-scroll page-header-modern main-content-boxed">
            <!-- Side Overlay-->
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            <li>
                                                <a class="active" href="be_layout_side_overlay_visible">Visible</a>
                                            </li>
                                            <li>
