...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-glass main-content-boxed">
            <!-- Side Overlay-->
                                        ...
                                        <ul>
                                            <li class="open">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a class="active" href="be_layout_header_glass">Glass</a>
                                                    </li>
                                                    <li>
