...
<html lang="en" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o side-overlay-hover enable-page-overlay side-scroll page-header-modern main-content-boxed">
            <!-- Side Overlay-->
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_layout_side_overlay_hoverable">Hoverable</a>
                                            </li>
                                            <li>
