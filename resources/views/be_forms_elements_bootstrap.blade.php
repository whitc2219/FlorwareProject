                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    <li>
                                        <a class="active" href="be_forms_elements_bootstrap">Bootstrap Elements</a>
                                    </li>
                                    <li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <form action="be_forms_elements_bootstrap" method="post" enctype="multipart/form-data" onsubmit="return false;">
                                        <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <form action="be_forms_elements_bootstrap" method="post" onsubmit="return false;">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content block-content-full">
                                    <form class="form-inline" action="be_forms_elements_bootstrap" method="post" onsubmit="return false;">
