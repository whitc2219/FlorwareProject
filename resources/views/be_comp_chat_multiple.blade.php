                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            <li>
                                                <a class="active" href="be_comp_chat_multiple">Multiple</a>
                                            </li>
                                            <li>
                        ...
                        <ul class="js-chat-head nav nav-tabs nav-tabs-alt bg-body-light" data-toggle="tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#chat-window1">
                                    <img class="img-avatar img-avatar16" src="assets/media/avatars/avatar13.jpg" alt="">
                                    <span class="ml-5">Jeffrey</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#chat-window2">
                                    <img class="img-avatar img-avatar16" src="assets/media/avatars/avatar6.jpg" alt="">
                        ...
                        <div class="tab-content overflow-hidden">
                            ...
                            <div class="tab-pane fade show active" id="chat-window1" role="tabpanel">
                                ...
                                <div class="js-chat-form block-content block-content-full block-content-sm bg-body-light">
                                    <form action="be_comp_chat_multiple" method="post">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <ul class="nav-users mt-10 push">
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img class="img-avatar" src="assets/media/avatars/avatar16.jpg" alt="">
                                                        <i class="fa fa-circle text-warning"></i> Henry Harrison
                                                        <div class="font-w400 font-size-xs text-muted">Web Designer</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img class="img-avatar" src="assets/media/avatars/avatar12.jpg" alt="">
                                                        <i class="fa fa-circle text-warning"></i> Scott Young
                                                        <div class="font-w400 font-size-xs text-muted">Web Developer</div>
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <i class="fa fa-circle text-warning"></i> Thomas Riley
                                                        <div class="font-w400 font-size-xs text-muted">Copywriter</div>
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <ul class="nav-users mt-10 push">
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img class="img-avatar" src="assets/media/avatars/avatar8.jpg" alt="">
                                                        <i class="fa fa-circle text-muted"></i> Sara Fields
                                                        <div class="font-w400 font-size-xs text-muted">Photographer</div>
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img class="img-avatar" src="assets/media/avatars/avatar15.jpg" alt="">
                                                        <i class="fa fa-circle text-muted"></i> Ryan Flores
                                                        <div class="font-w400 font-size-xs text-muted">Web Designer</div>
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        ...
                                                        <i class="fa fa-circle text-muted"></i> Carol Ray
                                                        <div class="font-w400 font-size-xs text-muted">UI Designer</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img class="img-avatar" src="assets/media/avatars/avatar11.jpg" alt="">
                                                        <i class="fa fa-circle text-muted"></i> Brian Cruz
                                                        <div class="font-w400 font-size-xs text-muted">Copywriter</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img class="img-avatar" src="assets/media/avatars/avatar3.jpg" alt="">
                                                        <i class="fa fa-circle text-muted"></i> Megan Fuller
                                                        <div class="font-w400 font-size-xs text-muted">UI Designer</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0)">
                                                        <img class="img-avatar" src="assets/media/avatars/avatar11.jpg" alt="">
                                                        <i class="fa fa-circle text-muted"></i> Justin Hunt
                                                        <div class="font-w400 font-size-xs text-muted">Copywriter</div>
                                                    </a>
                                                </li>
                                            </ul>
