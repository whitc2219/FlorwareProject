    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                ...
                <div class="bg-body-light bg-pattern" style="background-image: url('assets/media/various/bg-pattern-inverse.png');">
                                ...
                                <div class="row no-gutters d-flex justify-content-center">
                                    <div class="col-md-10 col-xl-7">
                                        <div class="d-flex justify-content-between">
                                            <a class="btn btn-hero btn-alt-secondary" href="be_pages_dashboard">
        ...
        -->
        <script src="{{ asset('js/codebase.core.min.') }}" ></script>
        ...
        -->
        <script src="{{ asset('js/codebase.app.min.') }}" ></script>
    </body>
</html>