...
<html lang="en" class="no-focus">
    <head>
        ...
        <--<link href="{{ asset('css/codebase.min.css') }}" rel="stylesheet" type="text/css">-->
            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        ...
                        <ul class="nav-main">
                            <li>
                                <a class="active" href="bd_dashboard"><i class="si si-compass"></i>Dashboard</a>
                            </li>
                ...
                <div class="content content-full">
                    ...
                    <div class="row invisible" data-toggle="appear">
                        ...
                        <div class="col-6 col-md-4 col-xl-2">
                            <a class="block block-link-shadow text-center" href="be_pages_generic_inbox">
                        ...
                        <div class="col-6 col-md-4 col-xl-2">
                            <a class="block block-link-shadow text-center" href="be_pages_generic_profile">
                                <div class="block-content">
                                    <p class="mt-5">
                        ...
                        <div class="col-6 col-md-4 col-xl-2">
                            <a class="block block-link-shadow text-center" href="be_pages_forum_categories">
                        ...
                        <div class="col-6 col-md-4 col-xl-2">
                            <a class="block block-link-shadow text-center" href="be_pages_generic_search">
                                <div class="block-content">
                                    <p class="mt-5">
                        ...
                        <div class="col-6 col-md-4 col-xl-2">
                            <a class="block block-link-shadow text-center" href="be_comp_charts">
                                <div class="block-content">
                                    <p class="mt-5">
